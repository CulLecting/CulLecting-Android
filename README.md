...
로그인·온보딩, 행사 탐색·검색·상세, 사용자 프로필을 API와 연결했습니다. 구현 커밋은 2025년 3–5월에 기록되어 있습니다.
...
기록·카드 편집 관련 화면도 포함되지만 마지막 커밋에는 아카이빙 제외라고 명시돼 있습니다. 이 사례의 범위는 로그인·탐색·프로필 클라이언트입니다. 디자인·백엔드·iOS는 별도 팀 산출물입니다.
...
- 소스·담당 커밋·API와 화면 연결을 대조했습니다. 문서 정리 과정에서는 앱 빌드·실기기 실행을 수행하지 않았습니다.
