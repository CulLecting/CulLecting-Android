...
import '../../viewmodels/logins_viewmodel/change_password_view_model.dart';
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        loginViewModel.isButtonEnabled
                            ? () async {
                          bool isSuccess = await loginViewModel.changePassword(context);
                          if (isSuccess){
                            loginViewModel.navigateToLoginScreen(context);
                          }
                        }
                            : null,
