              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            enabled: !loginViewModel.isVerified, // 인증 성공 시 입력 비활성화
                        ...
                        if (!loginViewModel.isVerified) ...[
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: loginViewModel.emailController.text.isNotEmpty
                                  ? ()async {
                                await loginViewModel.verifyEmailCallButtonPressed();// 이메일 인증 API 호출 (뷰모델 내 메서드)
                              }
                              : null,
                              ...
                              child:
                                  FittedBox(
                                    fit: BoxFit.none,
                                    child: loginViewModel.isEmailVerifyCall
                                        ? Text("재전송", style: TextStyle( fontSize: 15.0,fontWeight: FontWeight.w700,))
                                        : Text("인증 요청", style: TextStyle( fontSize: 15.0,fontWeight: FontWeight.w700,)),
                                  ),
                            ),
                          ),
                        ],
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            decoration: defaultInputDecoration(
                              ...
                              isError: loginViewModel.verifyErrorMessage != null,
                              suffixIcon: Padding(
                                padding: EdgeInsets.only(right: 12, top: 15.0),
                                child: loginViewModel.isTimerVisible ?
                                Text(
                        ...
                        if (!loginViewModel.isVerified) ...[
                          ...
                          SizedBox(
                            width: 90.0,
                            child: ElevatedButton(
                              onPressed: loginViewModel.verifyController.text.isNotEmpty
                                  ? () async {
                    ...
                    errorBox(interval: _interval, errorMessage: loginViewModel.verifyErrorMessage),
                    ...
                    TextField(
                      ...
                      decoration: defaultInputDecoration(
                        isError: loginViewModel.passwordConditionErrorMessage != null,
                        hintText: "비밀번호",
                    ...
                    errorBox(interval: _interval, errorMessage: loginViewModel.passwordConditionErrorMessage),
                    ...
                    errorBox(interval: _interval, errorMessage: loginViewModel.passwordErrorMessage),
                    ...
                    errorBox(interval: _interval, errorMessage: loginViewModel.nickLengthErrorMessage),
                    // 개인정보 이용약관 동의 체크박스
                    Row(
                      children: [
                        GestureDetector(
